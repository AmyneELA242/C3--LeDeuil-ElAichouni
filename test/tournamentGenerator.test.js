...
describe("Test de développement piloté par les tests pour calculateFinalStageScores", () => {
    it('4. Calcule correctement le score de chaque équipe dans la phase finale', () => {
      const teams = [
        { name: 'Équipe 1', players: ['Joueur1', 'Joueur2', 'Joueur3'] },
        { name: 'Équipe 2', players: ['Joueur4', 'Joueur5', 'Joueur6'] },
        { name: 'Équipe 3', players: ['Joueur7', 'Joueur8', 'Joueur9'] },
    ...
    it('5. Lève une erreur si des équipes supplémentaires sont incluses dans les résultats de la phase finale', () => {
      const teams = [
        { name: 'Équipe 1', players: ['Joueur1', 'Joueur2', 'Joueur3'] },
        { name: 'Équipe 2', players: ['Joueur4', 'Joueur5', 'Joueur6'] },
        { name: 'Équipe 3', players: ['Joueur7', 'Joueur8', 'Joueur9'] },
    ...
    it('6. Gère correctement le cas où les résultats de la phase finale sont vides', () => {
      const teams = [
        { name: 'Équipe 1', players: ['Joueur1', 'Joueur2', 'Joueur3'] },
        { name: 'Équipe 2', players: ['Joueur4', 'Joueur5', 'Joueur6'] },
        { name: 'Équipe 3', players: ['Joueur7', 'Joueur8', 'Joueur9'] },
    ...
    it('7. Calcule correctement le score total de la phase finale', () => {
      const teams = [
        { name: 'Équipe 1', players: ['Joueur1', 'Joueur2', 'Joueur3'] },
        { name: 'Équipe 2', players: ['Joueur4', 'Joueur5', 'Joueur6'] },
        { name: 'Équipe 3', players: ['Joueur7', 'Joueur8', 'Joueur9'] },
